...
+ Lunetta, Giovanni
   - Complete the course with an A and hopefully pursue the Data Science Master's Program at UConn
   - Become proficient in building a machine learning model and properly interpreting the results
